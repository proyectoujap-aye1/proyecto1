...
public class Process {
    ...
    private static final String INVOI_FILE_NAME = "Factura";
    ...
    public static void requestItems (Scanner scanner, int tableNumber, int personsNumber, String[][] namePersons, int[][] itemPersons,
    String[][][] nameItems, int[][][] cantItems, double[][][] priceItems, int MAX_ITEMS_BY_PERSON) {
    ...
    public static void generateInvoice(int tableNumber, int personsNumber, String[][] namePersons, int[][] itemPersons,
    String[][][] nameItems, int[][][] cantItems, double[][][] priceItems) throws IOException {
        ...
        Validate.isValidArr(cantItems[0][0]) && Validate.isValidArr(priceItems[0][0])) {
            ...
            String fileName = Validate.checkDirectory(route) + "\\" + Process.generateFileName(INVOI_FILE_NAME) + ".txt";
